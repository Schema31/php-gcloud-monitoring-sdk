 ...
 * 
 * php -f exampleSendLogGelf.php STREAMNAME AUTHKEY FACILITY SHORTMESSAGE
 * 
 * Es. Invio log con parametri aggiuntivi
 * 
 * php -f exampleSendLogGelf.php STREAMNAME AUTHKEY FACILITY SHORTMESSAGE FULLMESSAGE 6 KEY1 VAL1 KEY2 VAL2
 */
try {
